...
function layout({ title, description, content, depth, noindex = false }) {
...
for (const article of articles) {
  ...
  fs.writeFileSync(path.join(articleDir, "index.html"), layout({ ...article, content, depth: 2, noindex: article.noindex === "true" }));
}
